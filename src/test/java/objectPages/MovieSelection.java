...
public class MovieSelection {
	...
	@FindBy(xpath = "//div[normalize-space()='Marathi']")
	WebElement movieLanguage;

	// Select Movie
	@FindBy(xpath = "(//div[contains(@class,'sc-')]//a[contains(@href,'/movies-pune/')])[1]")
	WebElement movieSelection;

	// Submit Selected Movie

	@FindBy(xpath = "//span[contains(text(),'Book tickets') or contains(text(),'Book Tickets')]")
